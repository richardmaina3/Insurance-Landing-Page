...
- **Visual direction — "Modern Advisor":** indigo/navy primary (oklch(28% 0.09 265)) + mint accent (oklch(78% 0.12 165)), geometric sans throughout — Space Grotesk for headings, IBM Plex Sans for body. Bolder asymmetric hero (circular + rotated-square background shapes behind the photo), icon-badge service cards, and a dark indigo contact section for visual contrast. Chosen from a 3-direction mockup comparison; keep new components consistent with this palette/type pairing rather than introducing new fonts or colors.
